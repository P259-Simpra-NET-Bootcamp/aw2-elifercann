    ...
    public class Staff
    {
        ...
        public class StaffConfiguration : IEntityTypeConfiguration<Staff>
        {
            ...
            public void Configure(EntityTypeBuilder<Staff> builder)
            {
                ...
                builder.Property(x => x.City).IsRequired(true).HasMaxLength(40);
                builder.Property(x => x.Country).IsRequired(true).HasMaxLength(40);
                builder.Property(x => x.Province).IsRequired(true).HasMaxLength(40);
                builder.Property(x => x.AddressLine1).IsRequired(true).HasMaxLength(60);
